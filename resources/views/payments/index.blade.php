                                ...
                                @foreach($payments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('/report/report1/' .$item->id) }}" title="Print Payment"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Print</button></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
